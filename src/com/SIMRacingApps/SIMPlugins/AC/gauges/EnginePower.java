 ...
 */
public class EnginePower extends ACGauge {

  public EnginePower(ACSIMPlugin plugin, Car car) {
    super(Type.ENGINEPOWER, car, new ACTrack(plugin), null, null, plugin);
  }

  @Override
  public Data getValueCurrent(String UOM) {
    return new Data(this.m_type, plugin.internals().getSessionStatic().maxPower,"%", State.NORMAL);
  }
}
